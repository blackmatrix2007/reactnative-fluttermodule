...
RCT_EXPORT_METHOD(startFlutterActivity:(NSString *)stringArgument 
                data:(NSString *)data
                ...
                callback:(RCTResponseSenderBlock)callback)
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        FlutterMethodChannel* moduleChannel;
         if (self.flutterEngine == nil && _flutterEngine == nil) {
            ...
            flutterViewController = [[FlutterViewController alloc] initWithProject:nil nibName:nil bundle:nil];
             ...
             FlutterEngine *fe = self.flutterEngine == nil ? self->_flutterEngine : self.flutterEngine;
            ...
            flutterViewController = [[FlutterViewController alloc] initWithEngine:fe nibName:nil bundle:nil];
             ...
             moduleChannel = [FlutterMethodChannel
                                                            methodChannelWithName:@"dev.flutter.example/counter"
        ...
        [moduleChannel invokeMethod:@"miniapp"
                                  arguments: data];
